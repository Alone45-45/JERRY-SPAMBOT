...
@Jerry.on(events.NewMessage(incoming=True, pattern=r"\%sspam(?: |$)(.*)" % hl))
@Jerry2.on(events.NewMessage(incoming=True, pattern=r"\%sspam(?: |$)(.*)" % hl))
@Jerry3.on(events.NewMessage(incoming=True, pattern=r"\%sspam(?: |$)(.*)" % hl))
@Jerry4.on(events.NewMessage(incoming=True, pattern=r"\%sspam(?: |$)(.*)" % hl))
@Jerry5.on(events.NewMessage(incoming=True, pattern=r"\%sspam(?: |$)(.*)" % hl))
@Jerry6.on(events.NewMessage(incoming=True, pattern=r"\%sspam(?: |$)(.*)" % hl))
@Jerry7.on(events.NewMessage(incoming=True, pattern=r"\%sspam(?: |$)(.*)" % hl))
@Jerry8.on(events.NewMessage(incoming=True, pattern=r"\%sspam(?: |$)(.*)" % hl))
@Jerry9.on(events.NewMessage(incoming=True, pattern=r"\%sspam(?: |$)(.*)" % hl))
@Jerry10.on(events.NewMessage(incoming=True, pattern=r"\%sspam(?: |$)(.*)" % hl))
async def spam(e):
...
@Jerry.on(events.NewMessage(incoming=True, pattern=r"\%sbigspam" % hl))
@Jerry2.on(events.NewMessage(incoming=True, pattern=r"\%sbigspam" % hl))
@Jerry3.on(events.NewMessage(incoming=True, pattern=r"\%sbigspam" % hl))
@Jerry4.on(events.NewMessage(incoming=True, pattern=r"\%sbigspam" % hl))
@Jerry5.on(events.NewMessage(incoming=True, pattern=r"\%sbigspam" % hl))
@Jerry6.on(events.NewMessage(incoming=True, pattern=r"\%sbigspam" % hl))
@Jerry7.on(events.NewMessage(incoming=True, pattern=r"\%sbigspam" % hl))
@Jerry8.on(events.NewMessage(incoming=True, pattern=r"\%sbigspam" % hl))
@Jerry9.on(events.NewMessage(incoming=True, pattern=r"\%sbigspam" % hl))
@Jerry10.on(events.NewMessage(incoming=True, pattern=r"\%sbigspam" % hl))
async def spam(e):
...
@Jerry.on(events.NewMessage(incoming=True, pattern=r"\%sdelayspam" % hl))
@Jerry2.on(events.NewMessage(incoming=True, pattern=r"\%sdelayspam" % hl))
@Jerry3.on(events.NewMessage(incoming=True, pattern=r"\%sdelayspam" % hl))
@Jerry4.on(events.NewMessage(incoming=True, pattern=r"\%sdelayspam" % hl))
@Jerry5.on(events.NewMessage(incoming=True, pattern=r"\%sdelayspam" % hl))
@Jerry6.on(events.NewMessage(incoming=True, pattern=r"\%sdelayspam" % hl))
@Jerry7.on(events.NewMessage(incoming=True, pattern=r"\%sdelayspam" % hl))
@Jerry8.on(events.NewMessage(incoming=True, pattern=r"\%sdelayspam" % hl))
@Jerry9.on(events.NewMessage(incoming=True, pattern=r"\%sdelayspam" % hl))
@Jerry10.on(events.NewMessage(incoming=True, pattern=r"\%sdelayspam" % hl))
async def spam(e):
    ...
    if e.sender_id in SUDO_USERS:
        if e.text[0].isalpha() and e.text[0] in ("/", "#", "@", "!"):
            return await e.reply(usage, parse_mode=None, link_preview=None)
        smex = await e.get_reply_message()
        JerryT = "".join(e.text.split(maxsplit=1)[1:]).split(" ", 2)
        JerryT = Jerry[1:]
        if len(JerryT) == 2:
            message = str(JerryT[1])
            counter = int(JerryT[0])
            sleeptime = float(JerryT[0])
            for _ in range(counter):
                async with e.client.action(e.chat_id, "typing"):
                    if e.reply_to_msg_id:
                        await smex.reply(message)
...
@Jerry.on(events.NewMessage(incoming=True, pattern=r"\%spornspam(?: |$)(.*)" % hl))
@Jerry2.on(events.NewMessage(incoming=True, pattern=r"\%spornspam(?: |$)(.*)" % hl))
@Jerry3.on(events.NewMessage(incoming=True, pattern=r"\%spornspam(?: |$)(.*)" % hl))
@Jerry4.on(events.NewMessage(incoming=True, pattern=r"\%spornspam(?: |$)(.*)" % hl))
@Jerry5.on(events.NewMessage(incoming=True, pattern=r"\%spornspam(?: |$)(.*)" % hl))
@Jerry6.on(events.NewMessage(incoming=True, pattern=r"\%spornspam(?: |$)(.*)" % hl))
@Jerry7.on(events.NewMessage(incoming=True, pattern=r"\%spornspam(?: |$)(.*)" % hl))
@Jerry8.on(events.NewMessage(incoming=True, pattern=r"\%spornspam(?: |$)(.*)" % hl))
@Jerry9.on(events.NewMessage(incoming=True, pattern=r"\%spornspam(?: |$)(.*)" % hl))
@Jerry10.on(events.NewMessage(incoming=True, pattern=r"\%spornspam(?: |$)(.*)" % hl))
async def pspam(e):
    if e.sender_id in SUDO_USERS:
        if e.text[0].isalpha() and e.text[0] in ("/", "#", "@", "!"):
            return await e.reply(usage, parse_mode=None, link_preview=None )
...
@Jerry.on(events.NewMessage(incoming=True, pattern=r"\%shang(?: |$)(.*)" % hl))
@Jerry2.on(events.NewMessage(incoming=True, pattern=r"\%shang(?: |$)(.*)" % hl))
@Jerry3.on(events.NewMessage(incoming=True, pattern=r"\%shang(?: |$)(.*)" % hl))
@Jerry4.on(events.NewMessage(incoming=True, pattern=r"\%shang(?: |$)(.*)" % hl))
@Jerry5.on(events.NewMessage(incoming=True, pattern=r"\%shang(?: |$)(.*)" % hl))
@Jerry6.on(events.NewMessage(incoming=True, pattern=r"\%shang(?: |$)(.*)" % hl))
@Jerry7.on(events.NewMessage(incoming=True, pattern=r"\%shang(?: |$)(.*)" % hl))
@Jerry8.on(events.NewMessage(incoming=True, pattern=r"\%shang(?: |$)(.*)" % hl))
@Jerry9.on(events.NewMessage(incoming=True, pattern=r"\%shang(?: |$)(.*)" % hl))
@Jerry10.on(events.NewMessage(incoming=True, pattern=r"\%shang(?: |$)(.*)" % hl))
async def hang(e):
...
@Jerry.on(events.NewMessage(incoming=True, pattern=r"\%spackspam(?: |$)(.*)" % hl))
@Jerry2.on(events.NewMessage(incoming=True, pattern=r"\%spackspam(?: |$)(.*)" % hl))
@Jerry3.on(events.NewMessage(incoming=True, pattern=r"\%spackspam(?: |$)(.*)" % hl))
@Jerry4.on(events.NewMessage(incoming=True, pattern=r"\%spackspam(?: |$)(.*)" % hl))
@Jerry5.on(events.NewMessage(incoming=True, pattern=r"\%spackspam(?: |$)(.*)" % hl))
@Jerry6.on(events.NewMessage(incoming=True, pattern=r"\%spackspam(?: |$)(.*)" % hl))
@Jerry7.on(events.NewMessage(incoming=True, pattern=r"\%spackspam(?: |$)(.*)" % hl))
@Jerry8.on(events.NewMessage(incoming=True, pattern=r"\%spackspam(?: |$)(.*)" % hl))
@Jerry9.on(events.NewMessage(incoming=True, pattern=r"\%spackspam(?: |$)(.*)" % hl))
@Jerry10.on(events.NewMessage(incoming=True, pattern=r"\%spackspam(?: |$)(.*)" % hl))
